    ...
    fa: {
        actors: {
            ...
            'sara': {
                name: 'زهرا معصومی',
                role: 'سارا',
                bio: 'زهرا معصومی نقش سارا (خواهر) را در فیلم (Foreign Homeland) ایفا میکند. او بیش از شش سال تجربهٔ بازیگری دارد و با اشتیاق فراوان به زنده کردن شخصیتها و برقراری ارتباط با مخاطبان میپردازد. بازیگری به او اجازه میدهد تا وارد داستانهای گوناگون شود و از طریق اجرا، جنبههای مختلف انسانیت را کاوش کند. آثار او هم در تئاتر و هم در سینما گسترده است.روی صحنه، در اجراهایی همچون «هنر» (The Art)، «چراغها خاموش» (Lights Out)، «آنتیگونه» (Antigone) و «دیگ جوشان» (The Crucible) حضور داشته است!روی پردهٔ سینما، نقش اصلی سارا را در فیلم «سرزمین غریب» (Foreign Homeland)، نقش اصلی الهام را در فیلم «دو پرنده» (Two Birds) — هر دو به کارگردانی آرمین زرینغلام — و همچنین نقش بهاره در فیلم «آسمان خالی» (Empty Heaven) به کارگردانی عبدالرضا کاهانی ایفا کرده است.'
            },
            'soheila': {
                name: 'صفورا نقوی',
                role: 'سهیلا',
